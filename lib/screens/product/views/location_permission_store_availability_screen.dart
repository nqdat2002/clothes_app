              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Định vị vị trí của bạn đã bị tắt.",
                      style: TextStyle(
                          fontSize: 18,
                    ...
                    const SizedBox(height: defaultPadding),
                    const Text(
                      "Bật Dịch vụ định vị trong Cài đặt thiết bị của bạn để tìm kiếm cửa hàng theo vị trí hiện tại. Bạn vẫn có thể tìm kiếm theo Quốc gia/Khu vực, Thành phố hoặc Mã bưu chính.",
                    ),
