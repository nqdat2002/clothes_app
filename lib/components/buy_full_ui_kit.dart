...
class _BuyFullKitState extends State<BuyFullKit> {
  ...
  Future<void> buyLink() async {
    if (!await launchUrl(_url)) {
      throw Exception('Không thể tải $_url');
    }
  }
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        "Cảm ơn bạn đã sử dụng ứng dụng của chúng tôi. Để ủng hộ chúng tôi, bạn có thể mua toàn bộ mã nguồn của ứng dụng này.",
                      ),
                      const SizedBox(height: defaultPadding),
                      Row(
                        children: [
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              label:
                                  Text(_isCopied ? "Link đã được sao chép" : "Sao chép link"),
